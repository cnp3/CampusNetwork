...
# Useful variables
STUDENTS_2="fd00:200:3:305::/64"
STUDENTS_3="fd00:300:3:305::/64"
...
echo 'Setting default policies'
    ...
    for k in 200 300
    do
        ip6tables -A FORWARD -p tcp -s fd00:$k:3:405::/64 -d fd00:$k::3/48 --destination-port 80 -j ACCEPT
        ip6tables -A FORWARD -p tcp -s fd00:$k:3:405::/64 -d fd00:$k::3/48 --destination-port 443 -j ACCEPT
    done
