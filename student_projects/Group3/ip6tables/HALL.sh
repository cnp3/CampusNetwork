...
# Useful variables
STUDENTS_2="fd00:200:3:300::/64"
STUDENTS_3="fd00:300:3:300::/64"
...
echo 'Setting default policies'
    ...
    for k in 200 300;
    do
        ip6tables -A FORWARD -p tcp -s fd00:$k:3:400::/64 -d fd00:$k::3/48 --destination-port 80 -j ACCEPT
        ip6tables -A FORWARD -p tcp -s fd00:$k:3:400::/64 -d fd00:$k::3/48 --destination-port 443 -j ACCEPT;
    done
    ...
    do
        ...
        ip6tables -A FORWARD -s $camera200 -d fd00:300::3/48 -j DROP
        ip6tables -A OUTPUT -s $camera200 -d fd00:300::3/48 -j DROP
        ip6tables -A FORWARD -s $camera300 -d fd00:300::3/48 -j DROP
        ip6tables -A OUTPUT -s $camera300 -d fd00:300::3/48 -j DROP;
    done
