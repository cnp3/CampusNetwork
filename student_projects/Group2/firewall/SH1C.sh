...
ip6tables -A INPUT -j NFLOG --nflog-prefix "[DROP-INPUT]SH1C"
ip6tables -A FORWARD -j NFLOG --nflog-prefix "[DROP-FORWARD]SH1C"
ip6tables -A OUTPUT -j NFLOG --nflog-prefix "[DROP-OUTPUT]SH1C"
