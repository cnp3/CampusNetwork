...
ip6tables -A INPUT -j NFLOG --nflog-prefix "[DROP-INPUT]STEV"
ip6tables -A FORWARD -j NFLOG --nflog-prefix "[DROP-FORWARD]STEV"
ip6tables -A OUTPUT -j NFLOG --nflog-prefix "[DROP-OUTPUT]STEV"
