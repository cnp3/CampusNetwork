...
ip6tables -A INPUT -i pop300 -s fd00:200:2::/48 -j DROP
ip6tables -A INPUT -i pop300 -s fd00:300:2::/48 -j DROP
ip6tables -A FORWARD -i pop300 -s fd00:200:2::/48 -j DROP
ip6tables -A FORWARD -i pop300 -s fd00:300:2::/48 -j DROP

# Allow BGP
ip6tables -A INPUT -i pop300 -p tcp --dport 179 -j ACCEPT
ip6tables -A INPUT -i pop300 -p tcp --sport 179 -j ACCEPT
ip6tables -A OUTPUT -o pop300 -p tcp --dport 179 -j ACCEPT
...
# Block DHCP from leaving or entering the network through pop300
ip6tables -A INPUT   -p udp -i pop300 -m multiport --dports 546,547 -j DROP
ip6tables -A FORWARD -p udp -i pop300 -m multiport --dports 546,547 -j DROP
ip6tables -A FORWARD -p udp -o pop300 -m multiport --dports 546,547 -j DROP
ip6tables -A OUTPUT  -p udp -o pop300 -m multiport --dports 546,547 -j DROP
...
ip6tables -A FORWARD -p ipv6-icmp -i pop300 -j DROP
...
ip6tables -A INPUT -j NFLOG --nflog-prefix "[DROP-INPUT]HALL"
ip6tables -A FORWARD -j NFLOG --nflog-prefix "[DROP-FORWARD]HALL"
ip6tables -A OUTPUT -j NFLOG --nflog-prefix "[DROP-OUTPUT]HALL"
