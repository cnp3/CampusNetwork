...
ip6tables -A INPUT -j NFLOG --nflog-prefix "[DROP-INPUT]MICH"
ip6tables -A FORWARD -j NFLOG --nflog-prefix "[DROP-FORWARD]MICH"
ip6tables -A OUTPUT -j NFLOG --nflog-prefix "[DROP-OUTPUT]MICH"
